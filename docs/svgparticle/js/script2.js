...
DeviceInfo.isTouchDevice = "ontouchstart" in document;
DeviceInfo.lowSpecMode = DeviceInfo.isTouchDevice;
...
var DeviceInfo_1 = __webpack_require__(3);
/**
 * メインのレイヤー
 */
var ParticleLayer = (function () {
    function ParticleLayer(svgField) {
        ...
        if (!DeviceInfo_1.default.isTouchDevice) {
            ...
            window.addEventListener(EventName_1.EventName.TOUCH_START, function (event) { return _this.mouseDownHandler(event); });
            window.addEventListener(EventName_1.EventName.TOUCH_MOVE, function (event) { return _this.touchMoveHandler(event); });
            window.addEventListener(EventName_1.EventName.TOUCH_END, function (event) { return _this.mouseUpHandler(event); });
        }
        this.tick();
    }
     ...
     * Tickイベントで実行される処理
     */
    ParticleLayer.prototype.touchMoveHandler = function (event) {
        // マウスの座標
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventName_1 = __webpack_require__(0);
var ParticleLayer_1 = __webpack_require__(4);
var Main2 = (function () {
    function Main2() {
...
var ParticleEmitter = (function () {
    function ParticleEmitter(svgElement) {
        this.particleCut = DeviceInfo_1.default.lowSpecMode ? 8 : 2;
    ...
    ParticleEmitter.prototype.emitParticle = function () {
        this._particleCount++;
        if (this._particleCount % this.particleCut != 0) {
            return;
        }
